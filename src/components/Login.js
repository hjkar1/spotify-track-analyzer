...
const Login = () => {
  return (
    <Container>
      ...
      <LinkButton
        href={`https://accounts.spotify.com/authorize?client_id=${clientID}&redirect_uri=${callbackURI}&scope=user-read-private%20user-read-email&response_type=token&state=123`}
      >
        Login
      </LinkButton>
    </Container>
